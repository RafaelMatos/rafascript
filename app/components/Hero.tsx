  ...
  return (
    <div className='pb-20 pt-36'>
      ...
      <Spotlight
        ...
        />
      <Spotlight
          className="-top-36 -left-15 md:-left-32 md:-top-20 h-screen"
          fill="blue"
        />
        <Spotlight
      ...
      <div className="h-[80vh] w-full dark:bg-black-100 bg-white  
    ...
    <div className='flex justify-center my-20 z-10 relative'>
      <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
        <h2 className=' uppercase tracking-widest text-xs text-center max-w-80 text-blue-100'>Dynamic Web Magic with Next.js</h2>
