...
export const gridItems = [
  {
    ...
    imgClassName: "w-full h-full [mask-image:linear-gradient(to_top,transparent,black_20%)]",
  ...
  {
    id: 3,
    title: "Minha techs stack",
    description: "Estou constantemente melhorando",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 5,
    title: "Atualmente construindo uma aplicação e-commerce em Next.js",
